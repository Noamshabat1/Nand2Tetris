...
class JackTokenizer:
    ...
    @staticmethod
    def is_it_empty_line(arr: list[list], i: int) -> bool:
        return arr[i] == ""
    ...
    @staticmethod
    def is_it_inline_comment(arr: list[list], i: int) -> bool:
        return arr[i][0:2] == "//"
    ...
    @staticmethod
    def drop_comments(input_lines: list) -> list:
        """
        ...
        while flag:
            ...
            # elif ("/*" in input_lines[cur]) and JackTokenizer.not_a_string(
            #         input_lines[cur].partition("/*")):
    ...
    def delete_white_spaces(self, input_arr: list) -> list:
        ...
        return self.drop_comments(clean_lines)
